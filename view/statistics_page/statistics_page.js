...
function goToFeedback() {
    window.location.href = '../adminView/feedback/feedback.html'
}
function goToStatistici() {
    window.location.href = 'statistics_page.html'
}
function goToAddAngajat() {
    window.location.href = '../adminView/addAngajat/html/addAngajat.html'
}
function goToDeconectare() {
    window.location.href = '../index.html'
}
function goToHome() {
    window.location.href = '../adminView/adminIndex.html'
}